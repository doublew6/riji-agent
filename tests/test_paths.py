...
def test_windows_defaults_use_localappdata(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("LOCALAPPDATA", r"C:\Users\example-user\AppData\Local")
    assert default_data_dir("win32") == Path(r"C:\Users\example-user\AppData\Local") / "riji-agent"
    assert default_log_dir("win32") == Path(r"C:\Users\example-user\AppData\Local") / "riji-agent" / "logs"
