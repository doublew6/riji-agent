...
DeepSeek is the default model adapter. The API key stays inside this object; it
is only ever sent in the Authorization header and never logged or included in
raised errors.
"""
